...
public class LinkedListTest {
    ...
    public boolean testRemove() {
        ...
        if (list.remove(data3)) {
            System.out.println("miguel se fosses levar n cu");
            return false;
        }

        if (!list.remove(data1)) {
            System.out.println("n metias aqui makumbas");
            return false;
        }

        if (list.size() != 1) {
            System.out.println("miguel ta agoirando");
            return false;
        }

        list.add(data1);
        if (!list.remove(data1)) {
            System.out.println("miguel sonha");
            return false;
        }
